...
function CartToOrderSuccess({ handleOrderSuccess}) {
  return (
    <section className="w-full lg:h-screen h-full fixed top-0 left-0 z-[99] lg:bg-black/30 bg-clear flex justify-center items-center">
      <div className="sticky mt-10 flex flex-col justify-center bg-white lg:w-fit w-[90vw] h-fit p-16 gap-y-10 border border-orange">
