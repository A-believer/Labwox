...
const Hero = () => {
  return (
       <section className="py-2 lg:pl-[60px] pl-6 lg:pr-[45px] pr-6 lg:flex md:flex-row flex-col bg-heroBg bg-contain bg-no-repeat rounded-[4px] justify-between">
      <div className="lg:pr-[30px] pr-0 mt-6">
        ...
        <div className="text-white flex mt-4 lg:h-[52px] h-[35.5px] lg:w-5/6 w-full">
