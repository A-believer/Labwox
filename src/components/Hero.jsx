...
const Hero = () => {
  return (
    <section className="lg:pt-[97px] pt-[40px] lg:pb-[30px] pb-[20px] lg:pl-[60px] pl-[24px] lg:pr-[45px] pr-[30px] lg:flex md:flex-row flex-col bg-heroBg bg-contain bg-no-repeat rounded-[4px]">
      <div className="lg:pr-[30px] pr-0 mx-auto mt-[37px]">
        <p><Header text1="Powering" text2="Research" text3="Capabilities in Africa"/></p>
        <p className="text-grey mt-[23px] w-[89%]">Labwox provides cutting-edge solutions to support research and learning in the chemical sciences</p>
        <form className="text-white flex mt-[38px] lg:h-[52px] h-[35.5px] w-5/6">
          <input type="text" placeholder="find research here" className="pl-[17px] placeholder:text-grey rounded-[4px] lg:text-[19px] text-[13px]  lg:leading-[20px] leading-[15px] bg-clear mr-2 w-2/3"/>
      ...
      <div className="bg-heroImg lg:w-[1000px] w-[380px] lg:mt-0 mt-9 lg:h-[580px] h-[321px] bg-contain bg-no-repeat flex flex-col justify-center items-center rounded-[8px]">
        {/* Hero Play Button */}
