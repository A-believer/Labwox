  ...
  useEffect(() => {
    ...
    return (
        <section className="bg-white lg:px-14 px-2 lg:pt-5 pt-3 lg:pb-10 pb-2">
            ...
            <div key={test.key} className="bg-whitebgii lg:pt-5 pt-0 lg:pl-5 lg:pr-3 px-2 lg:pb-4 pb-2 mt-5 lg:mx-20 mx-0">
            ...
            <ul className="lg:text-base text-sm leading-6 text-blackii font-medium lg:pl-5 lg:pr-3 px-2 flex flex-col gap-y-2 lg:mx-20 mx-0">
