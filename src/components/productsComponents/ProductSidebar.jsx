      ...
      <section className="lg:bg-white bg-none lg:pt-7 pt-0 lg:px-[14px] px-0 lg:pb-[600px] pb-0 text-blackii text-base leading-5 font-normal rounded shadow-2xl">
          ...
          <div className="lg:hidden block bg-clear">
              ...
              <div className=" flex justify-center items-center w-full">
                  <input placeholder="enter test..." type="text" className="rounded-l h-[47px] w-[70%] border border-orange ring-0 outline-none pl-4"/>
                  <button type="button" className="bg-orange flex justify-center items-center  gap-2 text-white py-[12px] px-1 rounded-r w-[30%]" onClick={() => setView((prev) => !prev)}>
