    ...
    <main>
      ...
      <div className="flex lg:px-20 px-6 lg:py-6 py-4 gap-x-2">
        <div className="flex border border-grey pr-2">
          <input placeholder="find research here" type="text" className="text-grey placeholder:text-grey border-none ring-0 active:border-none focus:border-none focus:ring-0 active:ring-0"/>
