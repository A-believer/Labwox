...
const Login = () => {
  return (
    <main className="flex h-full w-full">
      ...
      <form
        className="lg:w-1/2 w-full lg:h-screen h-full lg:pt-[30px] py-10 lg:px-20 px-10 flex flex-col ">
        <Link
          to="/">
          <img
            src={Logo}
        ...
        <button className="bg-orange text-center text-white text-lg font-medium leading-snug p-2.5 rounded mt-4 mb-8">Sign Up</button>

        <p className="mt-3 text-blackii">Already have an account? <Link to="/login" className="text-orange">Login</Link></p>
