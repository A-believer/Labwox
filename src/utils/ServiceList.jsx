      ...
      <div className="gap-y-[16px] bg-white">
          {products?.map((item) => (
            ...
            <div className="lg:mt-[53px] mt-[33px] text-blackii">
              ...
              <p className={` text-base leading-tight lg:mb-[32px] my-[24px] w-fit`}>{item.services}</p>
            </div>

            <div className="lg:mb-0 mb-[18px] lg:py-[50px] py-[30px] lg:px-[32px] px-[16px] bg-whitebgiii rounded w-full">
